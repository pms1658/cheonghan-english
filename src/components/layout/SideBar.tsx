            ...
            <div className="sidebar-scroll flex-1 overflow-y-auto overflow-x-hidden flex flex-col" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                <div className="mb-6 px-3">
                    ...
                    <div className="bg-white/5 rounded-xl xl:rounded-2xl py-1 mx-1 xl:mx-2 ring-1 ring-white/5 shadow-sm space-y-0.5">
                        <Link href="/board"
                            onClick={onClose}
                            className={`flex items-center justify-between px-4 py-2.5 mx-1 rounded-xl transition-all duration-200 ${pathname.startsWith('/board') ? 'bg-white/10 text-white font-bold' : 'text-white/60 font-medium hover:text-white hover:bg-white/5'}`}>
                        ...
                        <Link href="/feedback"
                            onClick={onClose}
                            className={`flex items-center justify-between px-4 py-2.5 mx-1 rounded-xl transition-all duration-200 ${pathname.startsWith('/feedback') ? 'bg-white/10 text-white font-bold' : 'text-white/60 font-medium hover:text-white hover:bg-white/5'}`}>
                        ...
                        <Link href="/guide"
                            onClick={onClose}
                            className={`flex items-center justify-between px-4 py-2.5 mx-1 rounded-xl transition-all duration-200 ${pathname.startsWith('/guide') ? 'bg-white/10 text-white font-bold' : 'text-white/60 font-medium hover:text-white hover:bg-white/5'}`}>
                        ...
                        <Link href="/writing"
                            onClick={onClose}
                            className={`flex items-center justify-between px-4 py-2.5 mx-1 rounded-xl transition-all duration-200 ${pathname.startsWith('/writing') ? 'bg-white/10 text-white font-bold' : 'text-white/60 font-medium hover:text-white hover:bg-white/5'}`}>

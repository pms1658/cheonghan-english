...
- "correctMeaning" is the original Korean meaning stored in the database. It may contain multiple meanings separated by commas (e.g., "Ï∂îÏ∏°?òÎã§, Í∞Ä?ïÌïò??).
...
2. Accept reasonable synonyms. For example: "Ï∂îÎ°†?òÎã§" for "Ï∂îÏ∏°?òÎã§", "?ÅÏÉÅ?òÎã§" for "?ÅÏÉÅ, Í∞Ä??, "Í∏∞Î??òÎã§" for "Í∏∞Ï¶ù?òÎã§".
3. Accept minor variations: "~?òÎã§" vs "~?òÎäî Í≤?, trailing particles like "Î•?, "??, "?? differences.
...
6. However, if the meaning is fundamentally different (e.g., "?¨Í≥º" for "apple" when the word means "apply"), mark INCORRECT.
